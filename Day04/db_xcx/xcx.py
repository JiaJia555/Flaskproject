...
movies = [
    {
        'id': '11211',
        'thumbnail': 'https://img3.doubanio.com/view/photo/s_ratio_poster/public/p2566870171.webp',
        'title': u'饥饿站台',
        'rating': u'7.8',
        'comment_count': 12000,
    ...
    },
    {
        'id': '34532',
        'title': u'道貌岸然',
        'thumbnail': u'https://img1.doubanio.com/view/photo/s_ratio_poster/public/p2593834538.webp',
        'rating': u'5.9',
        'comment_count': 39450,
        'authors': u'艾伦/马丽/沈腾'
    },
    {
        'id': '394558',
        'title': u'绅士们',
        'thumbnail': u'https://img9.doubanio.com/view/photo/m/public/p2592522995.webp',
        'rating': u'8.5',
        'comment_count': 38409,
        'authors': u'肖央 / 闫妮 / 小沈阳'
    },
...
@app.route("/list/")
def movie_list():
    # /list?categoty=xxx 电视和电影各对应不同的链接
    category = int(request.args.get("category"))
    # print(category)       <class 'str'>
    items = None
